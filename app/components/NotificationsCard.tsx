...
export default function NotificationsCard() {
  ...
  const enable = async () => {
    try {
      ...
      if (!sub) {
        ...
        if (!vapid) throw new Error('Mangler NEXT_PUBLIC_VAPID_PUBLIC_KEY (redeploy?)');
  ...
  // 🟢 Når alt er aktiveret: vis kun en lille, diskret strip
  if (enabled) {
    return (
  ...
  // 🔲 Ellers: vis “stort” kort med aktiver-knap og hjælpetekst
  return (
